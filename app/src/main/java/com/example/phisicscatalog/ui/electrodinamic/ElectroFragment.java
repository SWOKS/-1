...
import com.example.phisicscatalog.ui.optica.OpticaFragment;
...
public class ElectroFragment extends Fragment {
    ...
    private Toolbar toolbarElectro;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        electroViewModel = new ViewModelProvider(this).get(ElectroViewModel.class);
        View root = inflater.inflate(R.layout.fragment_electro, container, false);
...
//                getActivity().setActionBar(toolbarOptica);
                ...
                viewPager = root.findViewById(R.id.view_pager_electro);
